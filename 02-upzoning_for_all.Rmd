...
Under the current system, the zoned capacity of each LGA is kept only barely higher than the number of homes that need to be built. Planners do this because artificially restricting the choices of others makes their jobs easier to do.
