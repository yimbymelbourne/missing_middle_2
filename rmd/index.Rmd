...
It keeps both developers and NIMBYs happy but it’s inequitable and it's making the city a worse place to live. 
...
YIMBY Melbourne's [Missing Middle](https://assets-global.website-files.com/64a530aa67ffbab04c9c39ab/652284ad6a63b8b3ab424966_Missing-Middle-Report.pdf) zoning for Melbourne will introduce fairer zoning to create housing abundance.
...
This zone will support a European density, with beautiful street walls without setbacks to activate the street below. 

Buildings in Missing Middle zones will include neighbourhood services and amenities like cafes and shops. Off-street parking will be allowed, but nobody will be forced to buy a carpark that they dont' need. 
...
### More choice across Melbourne's residential zones
...
With the exception of Melbourne, most inner and middle ring councils are not doing enough to house Melbourne's future population, 
...
or if there is nobody wants to live in these new homes. YIMBY Melbourne has therefore carefully calculated
...
2) Any lot suitable for development within 500m of a tram stop or 1km of a train station is zoned "Missing Middle" and considered suitable for 6 storeys of housing with high lot coverage. The potential yield of these properties is calcualted based on the yield achieved by 6 storey Nightingdale developments.
3) General residential lots are rezoned to Residential Growth, to allow a moderate increase in density.
4) Neighbourhood lots are rezoned to General residential to allow a small increase in density on larger lots. 
3) For each lot, the value of property as well as construction costs and demand for apartments in that area are used to calculate whether new homes are potentially viable on that site
4) Each viable site contributes to that state's housing targets. Development isn't expected to occur on every viable site, but councils who have more viable sites will have a higher share of the state's housing target.  with councils responsible for its share of the state's target based on how many homes are built 
