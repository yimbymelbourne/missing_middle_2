...
missing_middle_lgas_without_vic_etc <- missing_middle_lgas[!(missing_middle_lgas %in% c("Kingston (Vic.)","Bayside (Vic.)"))]


lga_html <- paste0("https://yimby-mel.s3.ap-southeast-2.amazonaws.com/",str_replace_all(missing_middle_lgas_without_vic_etc," ","+"),".html")
walk2(missing_middle_lgas_without_vic_etc,lga_html,generateButton)
cat('</div>')
```
