```{r run-all-Moonee-Valley-code}
area_name <- "Moonee Valley"
...
We have outlined potential remedies for this [earlier in the report](housing-targets-that-work.html#due-to-existing-development-controls-and-overlays).

**An image here should end the article.**

[Return to LGA list](housing-targets-2024-25.html)