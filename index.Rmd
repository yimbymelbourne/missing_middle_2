...
Since the introduction of [Plan Melbourne](https://www.planning.vic.gov.au/guides-and-resources/strategies-and-initiatives/plan-melbourne), the city has relegated new apartments to a tiny number of "activity centres" on the city's most polluted, noisy, and dangerous streets. 
...
Land speculators are happy because they can more easily buy up the lion's share of developable plots. And rich NIMBYs are also happy because their assets are protected. But this status quo is inequitable, and it's making our city worse. 
...
People should not be restricted to a handful of arbitrarily-defined activity centres. Rather, they should be able to live across the entirety of the city, free to thrive within an interconnected network of 20-minute neighbourhoods across all 1,992 of Melbourne's tram stops and train stations.

Melbourne already has a plan to fix its missing middle: [YIMBY Melbourne's _Missing Middle_](http://yimby.melbourne/missing-middle), which lays out the overwhelming evidence of densification's social, environmental, and affordability benefits. 

This followup report aims to codify these benefits by outlining a new housing delivery paradigm across the 19 inner-city Melbourne councils where demand for denser living is highest. 
...
YIMBY Melbourne's evidence-based housing targets present a realistic number of homes that can be built across LGAs each year under more permissive zoning. 
...
Each council area's target has been carefully calculated based on real-world information. The full target calculation methodology is available [later in this report](/implementing-housing-targets.html#calculating-targets).
