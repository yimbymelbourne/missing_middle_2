...
**Building an accountable, outcomes-focused system for housing abundance.**
...
htmltools::withTags(table(
  id = "lga-summary",
    ...
    tr(
      td(id = "lga-2", "Annual increase in housing delivery:"),
      td(id = "lga-1", "1.9x")
    ),
  )
)
...
1. Upzone inner-middle Melbourne, increasing zoned capacity by `r multiplier`
...
![Source: _Melbourne's Missing Middle_](images/mmm_summary.jpeg)
