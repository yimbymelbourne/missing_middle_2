...
To create meaningful housing targets for a local area you need two key things. First, you need strong demand for more housing. And second, you need land available for development.
...
Targets should be publicly reported on through a combination of development and building approvals, commencements and completions.
...
### When no councils meet their targets

If construction-sector challenges prevent most council areas from meeting their target, then the State and Commonwealth must act immediately to increase capacity in the construction sector. Councils should not be penalised while this capacity is created.  

Land speculation could also act to reduce city-wide development, and council should implement the policies in [YIMBY Melbourne's Missing Middle](https://www.yimby.melbourne/missing-middle) policy document to prevent land speculation.  


### When some councils fall behind

Individual councils could fail to meet their targets either because there is not enough demand for housing in their area, or because of council policies that slow or prevent development.

The way in-which council housing targets are calcualted accounts for local-area demand, and so no council will ever be penalised for lack of demand for housing in its area. If demand falls, prices fall, and then this automatically adjusts down the target for that council area before any penalty occurs. 
