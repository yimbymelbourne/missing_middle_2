...
![Source: Melbourne's Missing Middle](images/wgt.png)
```{r}
...
total_upzoned_props_format <- format(total_upzoned_props, big.mark = ",")

# Y
upzoned_value_median_property <- median(upzoned_props$property_price, na.rm = TRUE)
upzoned_value_median_property_format <- {paste0("$", format(round(upzoned_value_median_property / 1e6, 2), nsmall = 2), "m")}
...
total_windfall_gain_median_property_format <- paste0("$", format(round(total_windfall_gain_median_property/1e9, 1), nsmall = 1), " billion")

```

For a house worth \$1m, a 4% improvement is \$40,000. Upon sale, \$12,000 of that uplift should be paid in tax, with the owner keeping the remaining \$28,000 windfall gain. 
